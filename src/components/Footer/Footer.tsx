...
import {FaLinkedin, FaGithub, FaTelegram, FaMailBulk, FaRegClipboard, FaTwitter, FaMedium} from "react-icons/fa"
            ...
            <div className={styles.topRow}>
                ...
                <div className={styles.contact}>
                    ...
                    <div className={styles.contactLinks}>
                        ...
                        <a className={styles.link} href={joinFormUrl} target="_blank"
                           rel="noopener noreferrer"
                        style={{flexDirection:'row-reverse'}}
                        >
                            <FaRegClipboard/><span>عضویت در نشریه</span>
                        </a>
                    </div>
                </div>
                ...
                <div className={styles.socials}>
                    ...
                    <div className={styles.socialLinks}>
                        <a className={styles.link} href={telegramUrl} target="_blank" rel="noopener noreferrer">
                        ...
                        <a className={styles.link} href={twitterUrl} target="_blank" rel="noopener noreferrer">
